...
function actualizarCarritoUI(){
    fetch('http://localhost:8081/croso/api/carrito/api-carrito.php?action=mostrar')
    .then(response =>{
...
const addItemToCarrito = id =>{
    fetch('http://localhost:8081/croso/api/carrito/api-carrito.php?action=add&id=' + id)
    .then(response =>{
...
const removeItemFromCarrito = id =>{
    fetch('http://localhost:8081/croso/api/carrito/api-carrito.php?action=remove&id=' + id)
    .then(res =>{
        return res.json();
    })
    .then(data =>{
